...
(function (b, f) {
    ...
    jPlayerPlaylist.prototype = {
        ...
        _createListItem: function (a) {
            var c =
                this,
                d = "<li data-id='" + a.id + "'><div>",
                d = d + ("<a href='javascript:;' class='" + this.options.playlistOptions.removeItemClass + "' data-id='" + a.id + "'>&times;</a>");
            if (a.free) {
                var e = !0,
            ...
            d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + a.title + (a.artist ?
                " <span class='jp-artist' data-id='" + a.id + "'> by： " + a.artist + "</span>" : "") + "</a>";
            return d += "</div></li>"
        },
       ...
       /* select: function (a) {
        ...
        select: function(index) {
            ...
            if(0 <= index && index < this.playlist.length) {
                ...
                b("#jp-name").html(this.playlist[index].title);
                b("#jp-name").attr('data-id',this.playlist[index].id);
                b('#jp-singer').html(this.playlist[index].artist);
                b('#jp-img').attr('src',this.playlist[index].singer_pic);
                b('#jp-singer').attr('data-singerId',this.playlist[index].singer_id);
                b(this.cssSelector.jPlayer).jPlayer("setMedia", this.playlist[this.current]);
            } else {
                this.current = 0;
            }
        },
        ...
        play: function(index) {
            ...
            if(0 <= index && index < this.playlist.length) {
                if(this.playlist.length) {
                    ...
                    if(hash==='#/song'){
                        location.hash='#/song?id='+this.playlist[index].id;
                    }
                }
